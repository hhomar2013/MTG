...
{{--                                    Start--}}
                                    <div class="language" style="position: absolute;bottom: 500px;">
                                        <h4>{{trans('translate.lang')}}</h4>      <hr>
                                        <ul class="nav">
                                            <li class="">
                ...
                <div class="col-md-6 col-lg-6 col-xl-7 d-none d-md-flex bg-primary-transparent">
					<div class="row wd-100p mx-auto text-center">
						<div class="col-md-12 col-lg-12 col-xl-12 my-auto mx-auto wd-100p">
							<img src="{{URL::asset('assets/img/sign.png')}}" class="my-auto ht-xl-80p wd-md-100p wd-xl-80p mx-auto" alt="logo">
						</div>
					</div>
				</div>
