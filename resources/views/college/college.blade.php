...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">{{trans('translate.college')}}</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ {{trans('translate.college_list')}}</span>
						</div>
					</div>
...
@section('content')
                                            ...
                                            <div class="table-responsive">
                                                <table class="table text-md-nowrap hover table-bordered" id="example1">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th class="wd-15p border-bottom-0">{{trans('translate.info')}}</th>
                                                    ...
                                                    @foreach($college as $row)
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="wd-15p border-bottom-0">{{$row->info}} </td>
		...
		<!-- main-content closed -->
                @include('college.college_actions')
...
@section('js')
    ...
    <script>
        ...
        $('#modaldemo2').on('show.bs.modal', function(event) {
            ...
            var p_name = button.data('c_name')
            var price = button.data('info')
            var modal = $(this)
            modal.find('.modal-body #id').val(id);
            modal.find('.modal-body #c_name').val(p_name);
            modal.find('.modal-body #info').val(price);
        })
    </script>
    {{--        End Edit --}}
